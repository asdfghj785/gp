...
rm -f "$DST_DIR/com.eudis.quant.daily-pick-save.plist"
...
launchctl disable "gui/$(id -u)/com.eudis.quant.daily-pick-save" >/dev/null 2>&1 || true
...
echo "Installed 09:16/09:21/09:25 staged exit sentinels and 15:35 5m sell-loop LaunchAgents. Retired 15:30 daily-pick-save."
